...
<p>
    <?php if ($user): ?>
        <a href="<?php echo $user->getURL() ?>" class="dcf-btn">My sites</a>
    <?php else: ?>
        <a href="<?php echo $base_url ?>auth/unl/" class="dcf-btn">My sites</a>
    <?php endif; ?>
    <a href="<?php echo $base_url ?>registry/" class="dcf-btn">Find a site</a>
    <?php if ($user): ?>
        <a href="<?php echo $base_url ?>sites/add/" class="dcf-btn">Add a site</a>
    <?php else: ?>
        <a href="<?php echo $base_url ?>auth/unl/?r=<?php echo urlencode($base_url . 'sites/add/') ?>" class="dcf-btn">Add a site</a>
    <?php endif; ?>
</p>

<?php if (!$user): ?>
    <p>
        <a href="<?php echo $base_url ?>auth/shib/" class="dcf-btn">Log in from a different institution</a>
        or
        <a href="<?php echo $base_url ?>auth/google/" class="dcf-btn">Log in with Google</a>
    </p>
<?php endif ?>
